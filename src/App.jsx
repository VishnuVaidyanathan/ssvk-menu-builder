...
function generatePDFContent(template, customerName, mandapam, startDate, endDate, addons, bakshanam, templateKey) {
  let content = "";
...
export default function CateringMenuBuilder() {
  ...
  const previewContent = generatePDFContent(template, customerName, mandapam, startDate, endDate, addons, bakshanam, templateKey);
